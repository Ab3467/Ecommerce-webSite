...
const Imagelist = [
  {
    ...
    description: "Lorem ipsum dolor sit amet consectetur adipisicing elit Delectus quidem ullam dolorem, velit est quis, dicta sint iure nobis enim corporis"
  },
  {
    id: 2,
    img: shopping,
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2">
                ...
                <div className="order-2 sm:order-1">
                  <div className="relative z-10">
                    <img src={data.img} alt="" className="w-[300px] h-[300px] sm:h-[450px] sm:w-[450px] sm:scale-125 lg:scale-125 object-contain mx-auto" />
                  </div>
                </div>
              </div>
            </div>
